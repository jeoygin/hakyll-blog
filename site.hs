...
feedConfiguration = FeedConfiguration
    { feedTitle       = "Jeoygin Wang"
    , feedDescription = "RSS feed for Jeoygin Wang's blog"
    , feedAuthorName  = "Jeoygin Wang"
    , feedAuthorEmail = "jeoygin at gmail dot com"
    , feedRoot        = "http://jeoygin.org"
    }
